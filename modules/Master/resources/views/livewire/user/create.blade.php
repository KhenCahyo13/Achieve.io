            ...
            <form wire:submit="save">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                    <div class="form-groups">
                        ...
                        <input type="text" placeholder="Enter fullname" class="text-input" wire:model="form.name">
                        @error('form.name')
                    ...
                    <div class="form-groups">
                        ...
                        <input type="text" placeholder="user@example.com" class="text-input" wire:model="form.email">
                        @error('form.email')
                            <span class="text-theme-xs text-error-500">
                                {{ $message }}
                            </span>
                    ...
                    <div class="form-groups">
                        ...
                        <input type="password" placeholder="Enter password" class="text-input" wire:model="form.password">
                        @error('form.password')
                            <span class="text-theme-xs text-error-500">
                                {{ $message }}
                            </span>
                    ...
                    <div class="form-groups">
                        ...
                        <input type="password" placeholder="Enter confirmation password" class="text-input"
