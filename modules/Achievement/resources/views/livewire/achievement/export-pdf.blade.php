<div x-show="isExportPdfModalOpen"
    class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto modal z-99999">
    <div x-show="isExportPdfModalOpen" x-transition:enter="transition-opacity ease-out duration-300"
    ...
    <div x-show="isExportPdfModalOpen" x-transition:enter="transition ease-out duration-300"
        ...
        @click.outside="isExportPdfModalOpen = false">
        {{-- Close Btn --}}
        <button @click="isExportPdfModalOpen = false"
        ...
        @can('export data achievement')
            <form wire:submit="export">
                    ...
                    <div class="form-groups col-span-full">
                        ...
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select class="select-input" :class="isOptionSelected && 'text-gray-800 dark:text-white/90'"
                                @change="isOptionSelected = true" wire:model="verificationStatus">
                ...
                <div class="flex items-center justify-end w-full gap-3 mt-6">
                    <button @click="isExportPdfModalOpen = false" type="button"
