<div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
    ...
    <div class="card p-5 md:p-6">
        ...
        <div class="mt-4 flex items-end justify-between">
            <div>
                <span class="text-sm text-gray-500 dark:text-gray-400">Competitions Approved</span>
                <h4 class="mt-2 text-title-sm font-bold text-gray-800 dark:text-white/90">
                    {{ $countApprovedCompetitions }}</h4>
            </div>
        </div>
    </div>
    <div class="card p-5 md:p-6">
        ...
        <div class="mt-4 flex items-end justify-between">
            <div>
                <span class="text-sm text-gray-500 dark:text-gray-400">Competitions Rejected</span>
                <h4 class="mt-2 text-title-sm font-bold text-gray-800 dark:text-white/90">
                    {{ $countRejectedCompetitions }}</h4>
            </div>
        </div>
    </div>
</div>
