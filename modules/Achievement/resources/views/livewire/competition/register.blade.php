<div x-show="isRegisterModalOpen"
    ...
    <div x-show="isRegisterModalOpen" x-transition:enter="transition-opacity ease-out duration-300"
    ...
    <div x-show="isRegisterModalOpen" x-transition:enter="transition ease-out duration-300"
        ...
        @click.outside="isRegisterModalOpen = false">
        {{-- Close Btn --}}
        <button @click="isRegisterModalOpen = false; isDetailsModalOpen = true;"
